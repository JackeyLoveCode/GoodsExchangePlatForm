...
<div style="border:1px solid #ddd">
	<form id="movieEditForm" action="${pageContext.request.contextPath }/admin/item/update" class="itemForm" enctype="multipart/form-data" method="post">
...
<script type="text/javascript">
	...
	function submitForm(){
		...
		$('#movieEditForm').form('submit', {
		    success: function(data){
		    	console.log(data);
		        var data = eval('(' + data + ')');  // change the JSON string to javascript object    
		        if (data.status == 200){    
		            alert(data.msg);
		            $("#movieEditWindow").window("close");
